    ...
    <div class="table-responsive">
      <div class="table-wrapper">
        ...
        <table class="table table-striped table-hover">
          ...
          <tbody>
          <ResultItem :resultprops="res" v-for="res in testresults" :key="res.formid" @checkMed="check"/>
          </tbody>
        </table>
      </div>
    </div>
...
import ResultItem from "@/components/TestResult/ResultItem";
...
export default {
  ...
  mounted() {
    if(this.uid!=null) {
      axios.get(LearnApi.link+"api/testresult/uid/" + this.uid)
          .then(response => {
      ...
      axios.get(LearnApi.link+"api/testresult/type/" + this.type + "/id/" + this.csid)
          .then(response => {
            this.testresults = response.data
            console.log(this.testresults)
          })
