<template>
  <div id="deleteRecord" class="modal">
      ...
      <div class="modal-content">
        <form>
          ...
          <div class="modal-footer">
            ...
            <input type="button" class="btn btn-danger" value="Delete" @click="deleteRe()">
          </div>
        </form>
      </div>
    </div>
...
export default {
  ...
  methods:{
    ...
    deleteRe(){
      if(this.obid!=null)
        this.$emit('submitDelete',this.obid)
      else {
        this.$emit('sumitManyDelete')
      }
    }
  },
  data(){
