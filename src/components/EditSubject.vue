      ...
      <div class="modal-content">
        <form>
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <label>Poster</label>
              <input id="editPoster" type="text" class="form-control">
            </div>
          </div>
          <div class="modal-footer">
            <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel" @click="disappear">
            <input type="submit" class="btn btn-info" value="Save" @click="saveEdit">
          </div>
        </form>
      </div>
    </div>
    ...
    appear(id) {
      ...
      axios.get(LearnApi.link+"api/subject/" + this.subjId)
          .then(response => {
            ...
            $("#editName").val(this.subject.name)
            $("#editPoster").val(this.subject.poster)
            console.log(this.subjects)
          })
      $("#editSubject").css("display", "block");
    },
    disappear() {
      $("#editSubject").css("display", "none");
    },
    saveEdit() {
      axios.put(LearnApi.link+"api/subject/" + this.subjId,
          {
            name: $("#editName").val(),
